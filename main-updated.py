...
plob_sound = pygame.mixer.Sound("media/pong.ogg")
score_sound = pygame.mixer.Sound("media/score.ogg")
middle_strip = pygame.Rect(screen_width/2 - 2,0,4,screen_height)

# Game objects
player = Player('media/Paddle.png',screen_width - 20,screen_height/2,5)
opponent = Opponent('media/Paddle.png',20,screen_width/2,5)
paddle_group = pygame.sprite.Group()
paddle_group.add(player)
paddle_group.add(opponent)

ball = Ball('media/Ball.png',screen_width/2,screen_height/2,4,4,paddle_group)
